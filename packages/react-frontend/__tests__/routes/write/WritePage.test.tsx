...
const mockedCreatePage = createPage as jest.MockedFunction<
  typeof backendApi.createPage
>;
const mockedGetUserDiaries = getUserDiaries as jest.MockedFunction<
  typeof backendApi.getUserDiaries
>;
...
describe("Write Page", () => {
  ...
  it("Test upload & status", async () => {
    ...
    const dropdownList = within(screen.getByRole("list")).getByText(
      "Test Diary",
    );
