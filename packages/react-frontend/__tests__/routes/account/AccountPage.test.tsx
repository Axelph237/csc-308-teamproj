...
const mockedEditPassword = editPassword as jest.MockedFunction<
  typeof backendApi.editPassword
>;
const mockedEditUser = editUser as jest.MockedFunction<
  typeof backendApi.editUser
>;
...
describe("AccountPage Component", () => {
  ...
  beforeEach(() => {
    ...
    mockedEditUser.mockResolvedValue({
      ...dummyUser,
  ...
  it("toast error weak new password through modal", async () => {
    ...
    const changePwdBtn = await screen.getByRole("button", {
    ...
    await waitFor(() => {
      expect(toastMock.error).toHaveBeenCalledWith(
        expect.stringContaining("Password must include"),
      );
    });
  });
