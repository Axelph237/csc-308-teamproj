...
const mockedFindRandomPage = findRandomPage as jest.MockedFunction<
  typeof backendApi.findRandomPage
>;
const mockedAddLike = addLike as jest.MockedFunction<typeof backendApi.addLike>;
const mockedPostComment = postComment as jest.MockedFunction<
  typeof backendApi.postComment
>;
