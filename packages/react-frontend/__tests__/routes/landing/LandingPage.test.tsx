...
describe("LandingPage Component", () => {
    ...
    it("renders RandomPage component", async () => {
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText("In Diary Share you can store and create diary entries, just like any great diary!")).toBeDefined();
            const loginButton = screen.getByRole("button", {name: "Login"});
            expect(loginButton).toBeDefined();

            const createProfButton = screen.getByRole("button", {name: "Create Profile"});
